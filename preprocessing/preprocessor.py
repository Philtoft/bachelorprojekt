...
class Preprocessor:
    def __init__(self, model_name: str):
        self._model: T5ForConditionalGeneration = T5ForConditionalGeneration.from_pretrained(model_name)
        self._tokenizer: T5TokenizerFast = T5TokenizerFast.from_pretrained(model_name)
    ...
    def preprocess_dataset(self):
        ...
        logger.warning("Saving processed dataset to './data/'...")
