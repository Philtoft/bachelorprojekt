...
class QG:
    ...
    def __init__(self, model: str, tokenizer: str):
        ...
        self._model: T5ForConditionalGeneration = AutoModelForSeq2SeqLM.from_pretrained(
            model).to(self._device)
        self._tokenizer: T5TokenizerFast = AutoTokenizer.from_pretrained(
            tokenizer, model_max_length=_MODEL_MAX_LENGTH)
    ...
    def __call__(self, context: str) -> list[dict]:
        ...
        for context_chunk in context_chunks:
            ...
            input_ids = self._tokenizer.encode(
                input_string, return_tensors="pt").to(self._device)
            ...
            questions = self._tokenizer.decode(
